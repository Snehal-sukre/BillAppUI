...
const ViewAllBills = () => {
  ...
  // Fetch all bills with food items on component mount
  useEffect(() => {
  ...
  if (bills.length === 0) return <div className="bill-container">Loading bills...</div>;

  return (
    <div className="all-bills-page">
      <h2 className="center-text">View All Bills</h2>
      <button onClick={() => navigate("/admin/viewOrders")} className="back-button">Back to Orders</button>
